...
**The L298N library fixes these lacks and brings advanced control to your motor setups.**
...
- Intelligent orders change (avoid BACKWARD FULLSPEED after FORWARD FULLSPEED directly to protect hardware)
